      ...
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-12 text-left">
          ...
          <Category title="Coiffure">
            ...
            Une expertise maîtrisée pour un style soigné.
          </Category>

          <Category title="Tresses">
            Vanilles, nattes, motifs.  
            Des tresses définies, propres et durables.
          </Category>

          <Category title="Locks">
            Retwist, crochet, départ locks et entretien complet.  
            Locks structurées et parfaitement entretenues.
          </Category>

          <Category title="Soins à la carte">
            Nettoyage facial, gommage, masque, extraction…  
            Des soins personnalisés pour un visage propre et éclatant.
          </Category>

          <Category title="Soin visage complet">
            Un soin en plusieurs étapes : nettoyage, vapeur, extraction, sérum et masque.  
            Le traitement idéal pour une peau saine.
          </Category>
